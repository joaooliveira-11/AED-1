...
string Aula::get_UcCode() const{
    return UcCode;
}
string Aula::get_WeekDay() const{
    return WeekDay;
}
double Aula::get_StartHour() const{
    return StartHour;
}
double Aula::get_Duration() const{
    return Duration;
}
string Aula::get_Type() const{
    return Type;
}
string Aula::get_ClassCode() const{
    return ClassCode;
}
void Aula::setUcCode(std::string ucCode){
    this->UcCode = ucCode;
}
void Aula::setClassCode(std::string classCode){
    this->ClassCode = classCode;
}
void Aula::setClassType(std::string classType){
    this->Type = classType;
}
void Aula::setDuration(double duration){
    this->Duration = duration;
}
void Aula::setStartHour(double startHour){
    this->StartHour = startHour;
}
void Aula::setWeekDay(std::string weekDay){
